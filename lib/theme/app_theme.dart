...
class AppColors {
  ...
  static const Color accentOrange = Color(0xFFFFA000); // Arrow, highlights
  ...
  static const Color pillBackground = Color(0xFFF5F5F5); // Route/weather/sunlight pills
  ...
  static const Color sunlightLines = Color(0xFFFFD700);
  static const Color snowflakeBlue = Color(0xFFADD8E6); // Light blue cooling
  static const Color greenCheck = Color(0xFF4CAF50);

  // Bus
  static const Color busBody = Color(0xFF79693D); // Dark olive-brown
  static const Color busBorder = Color(0xFF000000);

  // Footer (same as bottom background)
  static const Color footerBackground = Color(0xFFE5F3F8);

  // Button
  static const Color primaryButtonBg = Color(0xFFFFC107);
  ...
  static const LinearGradient primaryButtonGradient = LinearGradient(
    ...
    colors: [Color(0xFFFFD340), Color(0xFFFFC107)],
  );
}
